...
function fallbackResponse(prompt) {
  ...
  return `Revenue at risk: ₹1,47,230 across 10,000 transactions. AI detected UPI failure spike of 38%. Recommended: send recovery payment links with alternate methods.`;
}
